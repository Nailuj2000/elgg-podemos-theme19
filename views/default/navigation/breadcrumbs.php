...
if (is_array($breadcrumbs) && count($breadcrumbs) > 0) {
	...
	for ($i = 1;$i<$number_breadcrumbs; $i++) {
		...
		*/
		...
		$breadcrumb = $breadcrumbs[$i]['title'];
		$breadcrumb_link = $breadcrumbs[$i]['link'];

		echo "<li><div class='flecha_reves'></div><div class='contenido'><a href='$breadcrumb_link'>$breadcrumb</a></div><div class='flecha'></div></li>";
	}
}
